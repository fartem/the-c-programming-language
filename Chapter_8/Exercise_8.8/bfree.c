 ...
 * int the free list maintained by malloc and free. By using bfree, a user add a static
 * or external array to the fre elist at any time.
 */
...
void try_to_free(struct wtbheader *);
